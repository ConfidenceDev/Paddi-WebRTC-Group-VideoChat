...
import tv.paddi.android.utils.Constant;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    private ConstraintLayout mAbout, mInvite, mShare, mRate, mFeedback, mLicense, mTerms, mHelp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mFaceBtn = findViewById(R.id.con5);
        ...
        mInvite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    startActivity(Intent.createChooser(emailIntent, getResources().getString(R.string.invite)));
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(pageName)) {
                    ...
                    try {
                        ...
                        String url = "https://www.facebook.com/" + pageName;
                        intent = new Intent(Intent.ACTION_VIEW,
                                Uri.parse("fb://facewebmodal/f?href=" + url));

                    } catch (Exception e) {
                        // no Facebook app, revert to browser
                        String url = "https://facebook.com/" + pageName;
                        intent = new Intent(Intent.ACTION_VIEW);
